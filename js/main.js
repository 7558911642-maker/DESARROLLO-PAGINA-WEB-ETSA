...
(() => {
  ...
  const BANNER_IMAGES_BY_SELECTOR = [
    ...
    [".contacto-hero", [
      "img/banners/Contacto_banner1.png",
      "img/banners/Contacto_banner2.png",
      "img/banners/Contacto_banner3.png",
      "img/banners/contacto-banner4.png",
    ]],
    [".encomiendas-hero", [
      "img/banners/encomiendas_banner1.png",
      "img/banners/encomiendas_banner2.png",
      "img/banners/encomiendas_banner3.png",
      "img/banners/encomiendas-banner4.png",
    ]],
    [".hero-viaje", [
      "img/banners/Info_viaje_banner1.png",
      "img/banners/Info_viaje_banner2.png",
      "img/banners/Info_viaje_banner3.png",
      "img/banners/Info_viaje_banner4.png",
    ]],
    [".libro-reclamos-hero", [
      "img/banners/libro_reclamaciones_banner1.png",
      "img/banners/libro_reclamaciones_banner2.png",
      "img/banners/libro_reclamaciones_banner3.png",
    ]],
    [".nosotros-hero", [
      "img/banners/Nosotros_banner1.png",
      "img/banners/Nosotros_banner2.png",
      "img/banners/Nosotros_banner3.png",
      "img/banners/Nosotros-banner4.png",
    ]],
    [".faq-hero", [
    ...
    [".reserva-hero", [
      "img/banners/Reserva_banner1.png",
      "img/banners/Reserva_banner2.png",
      "img/banners/Reserva_banner3.png",
      "img/banners/Reserva_banner4.png",
    ]],
    [".servicios-hero", [
      "img/banners/servicios_banner1.png",
      "img/banners/servicios_banner2.png",
      "img/banners/servicios_banner3.png",
      "img/banners/servicios_banner4.png",
    ]],
    [".terminos-encomiendas-hero", [
      "img/banners/Términos_de_encomiendas_banner1.png",
      "img/banners/Términos_de_encomiendas_banner2.png",
      "img/banners/Términos_de_encomiendas_banner3.png",
    ]],
    [".terminos-viaje-hero", [
